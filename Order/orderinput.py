...
class input_order(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.Remark_textbox = customtkinter.CTkTextbox(self.input_top_, corner_radius=0,fg_color='white',border_color='black',text_color='black',border_width=1,font=("microsoft yahei", 22, 'bold'),height=100)
