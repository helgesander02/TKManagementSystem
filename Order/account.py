...
class acount(customtkinter.CTkFrame):
    def __init__(self, master,selected, **kwargs):
        ...
        try:
            ...
            self.o_id_=customtkinter.CTkLabel(self.left,text=f'訂單編號：{self.key_[self.i]}',font=("microsoft yahei", 22, 'bold'))
            self.m_id_=customtkinter.CTkLabel(self.left,text=f'會員名稱：{self.name}',font=("microsoft yahei", 22, 'bold'))
            o_bt=customtkinter.CTkButton(self.left,text='查看訂單細節',command=self.od_info)
            self.index_info=customtkinter.CTkLabel(self.left,text=f'{self.i+1}/{len(self.selected)}',font=("microsoft yahei", 22, 'bold'))
            ...
            ac_title_1=customtkinter.CTkLabel(self.ac_history_,text='收款日期',font=("microsoft yahei", 22, 'bold'))
            ac_title_2=customtkinter.CTkLabel(self.ac_history_,text='收款方式',font=("microsoft yahei", 22, 'bold'))
            ac_title_3=customtkinter.CTkLabel(self.ac_history_,text='收款金額',font=("microsoft yahei", 22, 'bold'))
            ac_title_4=customtkinter.CTkLabel(self.ac_history_,text='折讓',font=("microsoft yahei", 22, 'bold'))
            ac_title_5=customtkinter.CTkLabel(self.ac_history_,text='收款備註',font=("microsoft yahei", 22, 'bold'))
            ...
            l=0
            for i in recipit_:
                ac_title_1=customtkinter.CTkLabel(self.ac_history,text=f'{i.date}',font=("microsoft yahei", 22, 'bold'))
                ac_title_2=customtkinter.CTkLabel(self.ac_history,text=f'{i.m_way}',font=("microsoft yahei", 22, 'bold'))
                ac_title_3=customtkinter.CTkLabel(self.ac_history,text=f'{i.money}',font=("microsoft yahei", 22, 'bold'))
                ac_title_4=customtkinter.CTkLabel(self.ac_history,text=f'{i.discount}',font=("microsoft yahei", 22, 'bold'))
                ac_title_5=customtkinter.CTkLabel(self.ac_history,text=f'{i.remark}',font=("microsoft yahei", 22, 'bold'))
            ...
            self.sum_=customtkinter.CTkLabel(self,text=f'總計：{0 if sum_==None else sum_}         餘額：{sum_1-(0 if sum_==None else sum_)}',font=("microsoft yahei", 22, 'bold'))
            self.sum_.pack()
...
class od_info_ToplevelWindow(customtkinter.CTkToplevel):
    def __init__(self, *args,o_nb,m_id ,**kwargs):
        ...
        a=customtkinter.CTkLabel(self,text='取貨日期',text_color='black',font=("microsoft yahei", 20, 'bold'))
        a.grid(row=0,column=0) 
        a=customtkinter.CTkLabel(self,text='取貨方式',text_color='black',font=("microsoft yahei", 20, 'bold'))
        a.grid(row=0,column=1) 
        a=customtkinter.CTkLabel(self,text='訂單項目',text_color='black',font=("microsoft yahei", 20, 'bold'))
        a.grid(row=0,column=2)
        a=customtkinter.CTkLabel(self,text='是否取貨',text_color='black',font=("microsoft yahei", 20, 'bold'))
        a.grid(row=0,column=3)
        a=customtkinter.CTkLabel(self,text='金額',text_color='black',font=("microsoft yahei", 20, 'bold'))
        ...
        for key,value in od_l.items():
            a=customtkinter.CTkLabel(self,text=f'{value[2]}',text_color='black',font=("microsoft yahei", 22, 'bold'))
            a.grid(row=i,column=0) 
            a=customtkinter.CTkLabel(self,text=f'{value[3]}',text_color='black',font=("microsoft yahei", 22, 'bold'))
            a.grid(row=i,column=1) 
            a=customtkinter.CTkLabel(self,text=f'{value[4]}',text_color='black',font=("microsoft yahei", 22, 'bold'))
            a.grid(row=i,column=2,sticky='w')
            a=customtkinter.CTkLabel(self,text=f'{value[5]}',text_color='black',font=("microsoft yahei", 22, 'bold'))
            a.grid(row=i,column=3)
            a=customtkinter.CTkLabel(self,text=f'{value[6]}',text_color='black',font=("microsoft yahei", 22, 'bold'))
