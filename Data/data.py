...
class Main_Frame(customtkinter.CTkFrame):#數據分析
    def __init__(self, master, **kwargs):
        ...
        self.date1=DateEntry(a,selectmode='day')
        self.date2=DateEntry(a,selectmode='day')
        search=customtkinter.CTkButton(a,text='查詢',command=self.search)
...
class Main2_Frame(customtkinter.CTkFrame):#品項分析
    def __init__(self, master, **kwargs):
        ...
        title_label=customtkinter.CTkLabel(self.b,text='品項分析')
        title_label1=customtkinter.CTkLabel(self.b,text='所有品項名稱')
        title_label2=customtkinter.CTkLabel(self.b,text='銷售量')
        title_label3=customtkinter.CTkLabel(self.b,text='銷售總金額')
    ...
    def search(self):
        ...
        for key,value in pd.items():
            ...
            pd1=customtkinter.CTkLabel(self.b,text=key)
            pd2=customtkinter.CTkLabel(self.b,text=value[0])
            pd3=customtkinter.CTkLabel(self.b,text=value[1])
