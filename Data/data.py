...
class Main_Frame(customtkinter.CTkFrame):#數據分析
    def __init__(self, master, **kwargs):
        ...
        date_label=customtkinter.CTkLabel(a,text='日期',font=("microsoft yahei", 22, 'bold'))
        ...
        search=customtkinter.CTkButton(a,text='查詢',fg_color=("#5b5a5a"),command=self.search,font=("microsoft yahei", 22, 'bold'))
        output=customtkinter.CTkButton(a,text='輸出資料表',fg_color=("#5b5a5a"),command=self.output_excel,font=("microsoft yahei", 22, 'bold'))
        ...
        PAlabel1=customtkinter.CTkLabel(Profit_Analysis_frame,text='銷售總訂單數量',font=("microsoft yahei", 22, 'bold'))
        PAlabel2=customtkinter.CTkLabel(Profit_Analysis_frame,text='銷售總品項數量',font=("microsoft yahei", 22, 'bold'))
        PAlabel3=customtkinter.CTkLabel(Profit_Analysis_frame,text='銷售總購買人數量',font=("microsoft yahei", 22, 'bold'))
        PAlabel4=customtkinter.CTkLabel(Profit_Analysis_frame,text='銷售總金額',font=("microsoft yahei", 22, 'bold'))
        PAlabel5=customtkinter.CTkLabel(Profit_Analysis_frame,text='銷售優惠總額',font=("microsoft yahei", 22, 'bold'))
        PAlabel6=customtkinter.CTkLabel(Profit_Analysis_frame,text='銷售總利潤',font=("microsoft yahei", 22, 'bold'))
        ...
        self.PAlabel1_=customtkinter.CTkLabel(Profit_Analysis_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.PAlabel2_=customtkinter.CTkLabel(Profit_Analysis_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.PAlabel3_=customtkinter.CTkLabel(Profit_Analysis_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.PAlabel4_=customtkinter.CTkLabel(Profit_Analysis_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.PAlabel5_=customtkinter.CTkLabel(Profit_Analysis_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.PAlabel6_=customtkinter.CTkLabel(Profit_Analysis_frame,text='',font=("microsoft yahei", 22, 'bold'))
        ...
        pulabel1=customtkinter.CTkLabel(Pick_Up_frame,text='現場',font=("microsoft yahei", 22, 'bold'))
        pulabel2=customtkinter.CTkLabel(Pick_Up_frame,text='宅配',font=("microsoft yahei", 22, 'bold'))
        pulabel3=customtkinter.CTkLabel(Pick_Up_frame,text='銷售量',font=("microsoft yahei", 22, 'bold'))
        pulabel4=customtkinter.CTkLabel(Pick_Up_frame,text='銷售總金額',font=("microsoft yahei", 22, 'bold'))
        self.pulabel1_=customtkinter.CTkLabel(Pick_Up_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.pulabel2_=customtkinter.CTkLabel(Pick_Up_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.pulabel3_=customtkinter.CTkLabel(Pick_Up_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.pulabel4_=customtkinter.CTkLabel(Pick_Up_frame,text='',font=("microsoft yahei", 22, 'bold'))
        ...
        palabel1=customtkinter.CTkLabel(path_frame,text='現場',font=("microsoft yahei", 22, 'bold'))
        palabel2=customtkinter.CTkLabel(path_frame,text='網站',font=("microsoft yahei", 22, 'bold'))
        palabel3=customtkinter.CTkLabel(path_frame,text='銷售量',font=("microsoft yahei", 22, 'bold'))
        palabel4=customtkinter.CTkLabel(path_frame,text='銷售總金額',font=("microsoft yahei", 22, 'bold'))
        self.palabel1_=customtkinter.CTkLabel(path_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.palabel2_=customtkinter.CTkLabel(path_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.palabel3_=customtkinter.CTkLabel(path_frame,text='',font=("microsoft yahei", 22, 'bold'))
        self.palabel4_=customtkinter.CTkLabel(path_frame,text='',font=("microsoft yahei", 22, 'bold'))
        ...
        label1=customtkinter.CTkLabel(b,text='利潤分析',font=("microsoft yahei", 22, 'bold'))
        label2=customtkinter.CTkLabel(b,text='會員分析',font=("microsoft yahei", 22, 'bold'))
        label3=customtkinter.CTkLabel(b,text='通路分析',font=("microsoft yahei", 22, 'bold'))
...
class Main2_Frame(customtkinter.CTkFrame):#品項分析
    def __init__(self, master, **kwargs):
        ...
        title_label=customtkinter.CTkLabel(self.b,text='品項分析',font=("microsoft yahei", 22, 'bold'))
        title_label1=customtkinter.CTkLabel(self.b,text='所有品項名稱',font=("microsoft yahei", 22, 'bold'))
        title_label2=customtkinter.CTkLabel(self.b,text='銷售量',font=("microsoft yahei", 22, 'bold'))
        title_label3=customtkinter.CTkLabel(self.b,text='銷售總金額',font=("microsoft yahei", 22, 'bold'))
    ...
    def search(self):
        ...
        for key,value in pd.items():
            ...
            pd1=customtkinter.CTkLabel(self.b,text=key,font=("microsoft yahei", 22, 'bold'))
            pd2=customtkinter.CTkLabel(self.b,text=value[0],font=("microsoft yahei", 22, 'bold'))
            pd3=customtkinter.CTkLabel(self.b,text=value[1],font=("microsoft yahei", 22, 'bold'))
